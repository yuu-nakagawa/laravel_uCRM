                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            ...
                                            <div class="mt-20 p-2 w-full">
                                                <button type="button" @click="deleteItem(item.id)" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">削除する</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
